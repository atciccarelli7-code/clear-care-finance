...
### CAF-D-022 — Publisher-first audience strategy with tools as supporting utilities

- **Date:** 2026-08-29
- **Status:** CONFIRMED
- **Decision:** Present Community Acquired Finance first as an RN-led healthcare economics, healthcare finance, navigation, and healthcare-system publication. Use Andrew Ciccarelli's read-only book manuscript as protected intellectual source material; convert only the strongest ideas into researched articles; and retain existing calculators and decision systems as contextual utilities rather than the default growth engine. Begin with four substantial hospital-price, nonprofit-hospital, length-of-stay, and rehabilitation explainers rather than scaled AI content or another product.
- **Rationale:** The August 28 Google Search Console export reports only 20 sitewide clicks and 3,449 impressions, so CAF has not earned enough distribution to justify a software-first expansion or revenue optimization. The manuscript contains distinctive RN observations and analogies that generic publishers cannot reproduce, while the repository already contains 71 articles, 35 canonical tools, and working decision systems. Publication-first compounds the scarce founder asset without discarding completed utilities.
- **Evidence:** Full read-only review of the 406-paragraph Google Doc `Hospitals Are a Business — Rough Draft / Idea Dump`; August 28, 2026 Google Search Console Web export; production and 182-route repository audit; July 21 strategy research `What Makes Websites Succeed and What Community Acquired Finance Should Become`; current CMS, Medicare.gov, IRS, AHRQ, HHS OIG, MedPAC, and RAND evidence; work packet `2026-08-29-publisher-first-content-engine.md`.
- **Consequences:** The homepage, desktop/mobile navigation, article library, Hospital Economics hub, About, Methodology, Editorial Policy, and contextual article links become publication-led. Four canonical articles raise expected inventory from 182 to 186 routes and 71 to 75 articles. Two general explainers receive affirmative ad-eligible dispositions; two sensitive discharge explainers remain ad-free. No tool, database, account, payment, price, entitlement, or paid infrastructure is added or removed. The manuscript remains untouched and no future passage publishes automatically.
