...
### CAF-E-019 — August 28 search baseline, founder manuscript, and hospital-economics evidence

- **Date captured:** 2026-08-29
- **Claim or state:** The August 28, 2026 last-six-month Google Web export reports 20 clicks and 3,449 impressions in both the Chart sum and Devices totals. Desktop contributed 10 clicks/2,325 impressions, mobile 9/1,112, and tablet 1/12. The Pages table is non-additive at 21 clicks/3,974 impressions, and disclosed Queries contain 0 clicks/1,733 impressions because low-volume query data are privacy filtered. Early page signals include the hospital 403(b) article at 3 clicks/219 impressions/position 8.16, allowed amount at 0/308/58.94, facility fee at 0/86/10.15, observation status at 0/56/72.27, and the Hospital Economics hub at 0/43/75.40. The full 406-paragraph founder manuscript contains original price, nonprofit, staffed-capacity, length-of-stay, discharge, rehabilitation, insurance, and family-work observations, but it is not a factual authority.
- **Source:** Direct connected Google Drive/Docs/Sheets reads of `communityacquiredfinance.com-Performance-on-Search-2026-08-28` and `Hospitals Are a Business — Rough Draft / Idea Dump`; direct production/repository audit; CMS hospital price transparency, EOB, IPPS, and readmission sources; Medicare.gov SNF and IRF coverage; IRS charitable-hospital and Section 501(r) sources; AHRQ ED-boarding review; June 2026 HHS OIG post-acute prior-authorization evaluations; March 2026 MedPAC hospital chapter; RAND commercial hospital-price research.
- **Evidence class:** DIRECT-CURRENT for connected Drive, repository, and production state; PRIMARY-SOURCE for government rules and federal payment evidence; DIRECT-RESEARCH for RAND; FOUNDER-EXPERIENCE for manuscript observations; INFERENCE for topic priority and future audience value.
- **Used for:** Publisher-first positioning, four-article selection, factual correction, content triage, internal links, publisher disposition, and the durable CAF Content Engine.
- **Freshness trigger:** Any controlling-source change; 2026-11-30 rehab review; 28 and 90 settled days after release; a new Search Console export; new manuscript additions; or a privacy/safety correction.
- **Limitations:** Twenty clicks cannot establish product-market fit, causal SEO lift, demand size, reader satisfaction, or monetization readiness. Page/query tables are incomplete and non-additive. MedPAC aggregates do not describe every hospital or patient; OIG findings are defined payer/month samples; Original Medicare rules do not generalize to all plans; founder experience does not prove prevalence or universal practice.
- **Owner:** Editorial, evidence, SEO/discovery, healthcare context, product, privacy, and quality/release.

### CAF-E-020 — Founder-led systems portfolio, current rules, and pre-release validation

- **Date captured:** 2026-08-30
- **Claim or state:** The protected 406-paragraph manuscript yields two distinct high-value mechanisms not already represented by a canonical CAF article: the hospital as a system shock absorber and the household as an often-unpaid care setting. The existing observation-status route is the correct canonical destination for the manuscript's classification concern and has been upgraded rather than duplicated. Local generation now reports 188 canonical routes, 77 articles, 42 explicitly ad-eligible routes, 146 ad-free routes, 39 permanent redirects, and zero search-readiness warnings. The full local suite passes 759 tests across 136 files; lint has zero errors and 15 existing Fast Refresh warnings; the complete build, API TypeScript, publication, freshness, premium, institutional, patient-education, AdSense, 188-route prerender, redirect, sitemap, search, and unchanged 500 KiB bundle gates pass. The entry is 499.81 KiB and therefore remains a watch item. Local Playwright could not launch because the pinned Chromium executable is absent; no browser assertion ran locally.
- **Source:** Read-only connected Google Doc `Hospitals Are a Business — Rough Draft / Idea Dump`; strategic research PDF `What Makes Websites Succeed and What Community Acquired Finance Should Become`; current CMS EMTALA and MOON materials; Medicare.gov inpatient/outpatient status, SNF, status-change appeal, and home-health pages; current 42 CFR 482.43; AHRQ emergency-department boarding and IDEAL discharge resources; BLS `Unpaid Eldercare in the United States — 2023–2024`; ACL National Family Caregiver Support Program; DOL FMLA family-caregiver guidance; March 2026 MedPAC hospital chapter; local repository tests and generated release artifacts. The March 2026 AHA `Costs of Caring` report was used as an industry/adversarial perspective, not as the factual backbone.
- **Evidence class:** FOUNDER-EXPERIENCE for manuscript observations; PRIMARY-SOURCE for federal rules, national survey data, and agency guidance; INTERNAL-RECORD for strategy research; DIRECT-CURRENT for repository inventory and local validation; INFERENCE for article selection, system-shock interpretation, and expected reader value.
- **Used for:** Two finished founder-derived articles, the observation canonical upgrade, Hospital Economics and patient-guide internal links, homepage/article-directory discovery, route-level AdSense classification, the selected/deferred manuscript register, CAF-D-023, and the exact-head release plan.
- **Freshness trigger:** Medicare and care-transition review by 2026-11-30; systems explainer review by 2027-02-28; controlling-rule or source change; hosted-browser, preview, or production defect; AdSense decision; or 28/90 settled days of joined reader/Search evidence.
...
### CAF-E-022 — Founder article-engine portfolio and adversarial claim record

- **Date captured:** 2026-09-03
- **Claim or state:** The complete read-only founder manuscript review produced ten scored candidates. Two distinct new hospital-economics articles and one in-place prior-authorization rebuild cleared the editorial, duplicate-intent, evidence, and privacy gates. Local generation reports 190 canonical routes, 79 public articles, nine flagships, 44 ad-eligible routes, 146 ad-free routes, 39 permanent redirects, and zero search warnings. The full local suite passes 766 tests in 138 files; lint has zero errors and 15 inherited Fast Refresh warnings; the production build and unchanged 500 KiB entry budget pass at 499.30 KiB. The three prerendered pages have correct canonicals, H1s, Article schema, sources, and internal pathways.
- **Source:** Connected Google Doc `Hospitals Are a Business — Rough Draft / Idea Dump`; repository/project context and existing flagships; CMS EMTALA, Acute IPPS, IPPS guide, HCRIS, and CMS-0057-F; Federal Register; Medicare.gov appeals; HHS OIG 2022 defined Medicare Advantage denial review; March and July 2026 MedPAC; GAO-25-106995; David et al., *Do Hospitals Cross Subsidize?*; disclosed AHA industry perspective; local generated artifacts and validation output.
- **Evidence class:** FOUNDER-EXPERIENCE for Andrew's analogies, questions, and reasoning; PRIMARY-SOURCE for federal rules and current sector evidence; PEER-REVIEWED-BOUNDED for the historical two-state cross-subsidy study; STAKEHOLDER-PERSPECTIVE for AHA; DIRECT-CURRENT for repository/build/inventory state; INFERENCE for rankings and editorial synthesis.
- **Used for:** `/articles/hospitals-are-businesses-and-public-utilities`, rebuilt `/articles/prior-authorization-explained`, `/articles/hospital-profitable-unprofitable-service`, article archive and Hospital Economics placement, reciprocal internal links, publisher dispositions, CAF-D-025, and the updated CAF Content Engine.
- **Freshness trigger:** Controlling-rule change; source or runtime defect; 2026-12-03 prior-authorization review; 2027-03-03 hospital-economics reviews; or settled reader/Search evidence.
- **Limitations:** EMTALA is not universal free care. MedPAC aggregates do not describe every hospital, service, payer contract, or case. Public HCRIS data do not recreate every internal allocation. The cross-subsidy study is historical and limited to Arizona and Colorado around a specific market shock. OIG's 13 percent finding is a one-week June 2019 sample from 15 large Medicare Advantage organizations, not a current national rate. CMS-0057-F's timelines cover defined impacted payers and non-drug requests, with an explicit exchange-plan limitation. Local browser execution remains environment-blocked until hosted CI.
- **Owner:** Editorial, founder-voice, healthcare research, evidence, SEO/discovery, frontend, accessibility/performance, privacy, and quality/release.
