# Community Acquired Finance Work Packet Template
...
- Active decision IDs:
- Decisions potentially in conflict:
...
- What it omitted:
- Strongest argument against the obvious solution:
- Weakest assumption:
- Largest unused opportunity:
...
- [ ] Publication ownership, freshness, and correction paths are correct.
- [ ] Tests, lint, type checks, build, and repository-specific checks pass.
...
- Duplicate or stale artifact retired:
- One remaining process debt:
