...
**Final source commit:** `dbc7795b751806752bafaf743dccdf36262befcb`  
**Final Browser certification run:** `29837406845`  
**Workflow artifact:** `browser-certification-29837406845` / artifact `8497940205`

## Scope

The certification exercised the actual Chromium print-to-PDF rendering path for the following representative high-stress outputs:
...
- add print-only document titles and canonical route references where the screen interface supplied context outside the result.
...
The workflow artifact is retained for fourteen days. Representative final PDFs are also attached to Linear AND-70 as durable release evidence.
