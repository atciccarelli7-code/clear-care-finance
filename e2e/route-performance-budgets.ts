...
// Calibrated July 16, 2026 and revalidated July 31, 2026 from clean production-style builds at 390px.
...
export const ROUTE_PERFORMANCE_BUDGETS: RoutePerformanceBudget[] = [
  ...
  { group: "calculator_workspace", path: "/tools/private-student-loan-payoff-calculator", lcpMs: 900, cls: 0.05, longTaskMs: 500, javascriptBytes: 300_000, totalBytes: 325_000, requestCount: 45 },
  { group: "article_topic", path: "/articles/deductible-copay-coinsurance-out-of-pocket-max", lcpMs: 900, cls: 0.05, longTaskMs: 750, javascriptBytes: 590_000, totalBytes: 630_000, requestCount: 41 },
