...
export const quickGuideDefinitions = {
  "hospital-discharge-medicare-quick-guide": {
    ...
    subtitle: "A plain-English starting point for families before discharge, rehab, home support, long-term care, or a confusing bill.",
    ...
    coverEyebrow: "Visual hospital-family handout",
    coverChips: ["Status", "Payer", "Approval", "Documents", "Next call"],
    coverPathway: [
    ...
    pageThemeMap: {
      ...defaultPageThemeMap,
      2: { eyebrow: "Avoid costly assumptions", icon: "!", theme: "warning", cues: ["Do not assume", "Ask for proof", "Confirm possible cost"] },
      3: { eyebrow: "Program map", icon: "M", theme: "program", cues: ["Identify coverage", "Check state rules", "Verify provider fit"] },
      5: { eyebrow: "Status check", icon: "H", theme: "status", cues: ["Ask current status", "Confirm admission time", "Get notices"] },
      7: { eyebrow: "Rehab review", icon: "R", theme: "rehab", cues: ["Document skill", "Confirm facility", "Track appeal deadline"] },
      9: { eyebrow: "Bill check", icon: "$", theme: "billing", cues: ["Match documents", "Ask why owed", "Correct or appeal"] },
    },
