      ...
      <div className="container py-14 grid gap-10 md:grid-cols-12">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/patients-families" className="hover:text-primary transition-smooth">Patients</Link></li>
        ...
        <div className="md:col-span-3">
          <h4 className="font-semibold text-sm mb-3 text-foreground">Site policies</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/disclaimer" className="hover:text-primary transition-smooth">Disclaimer</Link></li>
            <li><Link to="/editorial-policy" className="hover:text-primary transition-smooth">Editorial Policy</Link></li>
            <li><Link to="/advertising-policy" className="hover:text-primary transition-smooth">Advertising Policy</Link></li>
          </ul>
        </div>
      </div>
