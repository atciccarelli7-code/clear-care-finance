  ...
  <div>
    ...
    <div className="mx-auto grid max-w-5xl gap-5 md:grid-cols-2">
      {factSheet.items.map((item) => (
        <article
          key={item.title}
          className="rounded-2xl border border-border bg-card p-6 shadow-card transition-smooth hover:border-primary/30 hover:shadow-hover md:p-7"
        >
          ...
          {item.reminder && (
            <div className="mt-5 flex items-start gap-3 rounded-xl border border-primary/20 bg-primary-soft/40 p-4">
