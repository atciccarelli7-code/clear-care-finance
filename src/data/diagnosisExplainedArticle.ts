...
export const DIAGNOSIS_EXPLAINED_ARTICLE: Article = {
  ...
  timeSensitive: false,
  reviewScope: "Editorial and safety framework, plus nurse review of the nine published Diagnosis, Explained guides.",
  ...
  summary: "Diagnosis, Explained is a governed patient-education system. The reader brings the diagnosis. Each published guide explains what it means, what it does not automatically mean, possible contributing causes, common evaluation, treatment goals, why medications may be prescribed, daily monitoring, warning signs, and questions to ask. The system does not collect symptoms, interpret individual test results, recommend a diagnosis, or direct an individual treatment plan. Nine complete guides are source checked, nurse reviewed, and available for public use.",
  body: [
    ...
    "The current library includes nine complete, source-checked, nurse-reviewed guides. Each remains educational rather than individualized and directs readers back to their treating clinicians for diagnosis, treatment choices, medication changes, and personal emergency instructions.",
  ],
  ...
  example: {
    title: `Published guide: ${heartFailurePilot.diagnosis}`,
    body: `${heartFailurePilot.intendedAudience} Scope: ${heartFailurePilot.scope} Current status: ${heartFailurePilot.status}.`,
  },
