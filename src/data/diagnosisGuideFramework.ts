...
export const DIAGNOSIS_GUIDE_PILOTS: readonly DiagnosisGuidePilot[] = [
  {
    ...
    scope: "A complete source-checked, nurse-reviewed guide covering meaning, major types, possible causes, evaluation, treatment goals, medication purpose, home monitoring, warning signs, devices, questions, and teach-back.",
  ...
  },
  {
    ...
    scope: "A complete source-checked, nurse-reviewed guide covering meaning, lung-disease patterns, possible contributors, spirometry and related evaluation, treatment goals, inhaler purpose and technique, pulmonary rehabilitation, oxygen, flare-up planning, warning signs, questions, and teach-back.",
  ...
  ...ADDITIONAL_DIAGNOSIS_GUIDES.map((guide) => ({
    ...
    scope: `${guide.scope} Source checked and nurse reviewed.`,
    route: guide.route,
  })),
];
