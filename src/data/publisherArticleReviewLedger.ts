import type { PublisherArticleReview } from "./publisherArticleReviews";
...
export const PUBLISHER_ARTICLE_REVIEWS: PublisherArticleReview[] = [
  ...
  eligible("how-a-hospital-actually-makes-money", "flagship", { reviewedAt: "2026-09-10", nextReviewAt: "2027-03-10" }),
