...
const recommendations: NavigatorRecommendation[] = [
  ...
  { id: "cost_prepare_care", pathway: "healthcare_costs", priority: "do_now", type: "checklist", title: "Prepare cost questions before planned medical care", reason: "Network status, authorization, care setting, facility fees, and separately billing services can change what a patient owes.", actionText: "Build a private cost preparation plan", destinationPath: "/tools/medical-appointment-cost-preparation", caution: "Do not delay emergency or urgently needed care to research cost or resolve an insurance question.", fixedAnalyticsId: "cost_prepare_care" },
