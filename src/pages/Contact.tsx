...
const Contact = () => {
  useSeo({
    title: "Contact",
    description: "Contact Community Acquired Finance about corrections, source questions, website issues, privacy requests, accessibility barriers, or educational topic ideas.",
  ...
  return (
    <>
      <PageHero
        ...
        description="Use this page for site feedback, correction requests, source questions, practical topic ideas, privacy requests, and accessibility barriers. Do not send private medical, financial, tax, legal, insurance, employer-plan, employee, member, student, or patient details."
      />
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                For corrections, source suggestions, website issues, privacy requests, accessibility barriers, or educational topic ideas, email the official Community Acquired Finance inbox:
              </p>
