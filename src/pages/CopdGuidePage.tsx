  ...
  return (
    <>
      ...
      <div className="container max-w-5xl space-y-20 py-12 md:py-16">
        ...
        <GuideSection id="tests" eyebrow="Evaluation" title="What each common test is trying to answer" description="COPD is not confirmed by symptoms or a scan alone. The patient should understand the purpose of spirometry and the tests around it.">
        ...
        <GuideSection id="sources" eyebrow="Trust and verification" title="Sources used to build this guide" description="The current GOLD strategy and federal patient resources support the content. Independent review remains the release gate.">
