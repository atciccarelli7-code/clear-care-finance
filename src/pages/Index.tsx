...
const Index = () => {
  ...
  return (
    <>
      ...
      {/* Choose your path */}
      <section id="choose-path" className="container py-16 md:py-20 scroll-mt-20">
        <SectionHeading
          centered
      ...
      <section className="container py-20">
        <div className="rounded-3xl bg-gradient-primary p-10 md:p-16 text-center text-primary-foreground shadow-hover">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-4 text-balance">Start with one small win</h2>
