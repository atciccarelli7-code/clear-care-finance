    ...
    <>
      ...
      <section className="container max-w-3xl py-12 md:py-16 space-y-6" aria-label="Privacy policy details">
        ...
        <Section title="Privacy choices and Google Consent Mode">
          ...
          <p>Site-generated analytics event URLs are reduced to an origin and pathname before they enter the analytics data layer. Query strings and URL fragments are not intentionally included in page-view, destination-path, or outbound-link event fields. The first-party evidence system stores fixed destination identifiers rather than URLs.</p>
