...
export default function MedicareCoverageDecisionAppPage() {
  ...
  const create = async (title: string) => {
    ...
    setStatus("saving");
    try {
      const created = await createMedicareWorkspace(auth.accessToken, title);
